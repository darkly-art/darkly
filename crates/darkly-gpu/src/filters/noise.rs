...
impl NoiseHandler {
    pub fn new(device: &wgpu::Device, format: wgpu::TextureFormat) -> Self {
        let bind_group_layout =
            device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
                ...
                entries: &[
                    // binding 0: input accumulator texture
    ...
    /// Generate a noise texture filled with random values.
...
impl FilterHandler for NoiseHandler {
    ...
    fn create_params(&self, js: JsValue) -> Box<dyn FilterParams> {
        ...
        Box::new(NoiseParams { amount, resolution })
    }
    ...
    fn create_instance(
        ...
        let noise_params = params
            .as_any()
            .downcast_ref::<NoiseParams>()
            .expect("NoiseHandler received non-NoiseParams");

        let uniforms = NoiseUniforms {
            amount: noise_params.amount,
            resolution: noise_params.resolution as f32,
            _pad0: 0.0,
            _pad1: 0.0,
        };
