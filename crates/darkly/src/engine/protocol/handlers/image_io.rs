...
pub fn registrations() -> Vec<RequestRegistration> {
    vec![
        RequestRegistration::new::<Value, Value>("start_export", |engine, _payload, _b| {
            engine.start_export();
            Ok(Response::deferred())
        }),
        RequestRegistration::new::<Value, Value>("start_save_document", |engine, payload, _b| {
        ...
        RequestRegistration::new::<Value, Value>("open_document", |engine, _payload, bytes| {
