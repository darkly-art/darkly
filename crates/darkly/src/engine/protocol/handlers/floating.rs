...
pub fn registrations() -> Vec<RequestRegistration> {
    vec![
        ...
        RequestRegistration::new::<Value, Value>("commit_floating", |engine, _payload, _b| {
            engine.commit_floating();
            Ok(Response::empty())
        }),
        RequestRegistration::new::<Value, Value>("cancel_floating", |engine, _payload, _b| {
        ...
        RequestRegistration::new::<Value, Value>("begin_transform", |engine, payload, _b| {
        ...
        RequestRegistration::new::<Value, Value>("has_floating", |engine, _payload, _b| {
            Ok(Response::json(json!({ "value": engine.has_floating() })))
        }),
        RequestRegistration::new::<Value, Value>("floating_info", |engine, _payload, _b| {
