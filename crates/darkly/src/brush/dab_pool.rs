...
/// Re-export so existing dispatch-path code can keep using
/// `dab_pool::DAB_REFERENCE_SIZE` until those references migrate.
/// Canonical home is `crate::brush::DAB_REFERENCE_SIZE`.
pub use super::DAB_REFERENCE_SIZE;
